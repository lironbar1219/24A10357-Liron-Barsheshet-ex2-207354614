...
import com.example.myfirstapp.Utillities.MovementDetector;
...
public class MainActivitySensors extends AppCompatActivity implements MovementDetector.OnTiltListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        movementDetector.setOnTiltListener(this);
    ...
    protected void onResume() {
        ...
        movementDetector.start(); // Start listening to sensor events
    }

    @Override
    protected void onPause() {
        super.onPause();
        successSound.stopSoundSuccess();
        failSound.stopSoundFail();
        movementDetector.stop(); // Stop listening to avoid battery drain
    }
    ...
    @Override
    public void onColumnTilt(int column) {
        int spaceshipPos = gameManager.getPosSpaceShip();
        //System.out.println("Spaceship pos = " + spaceshipPos + ". and column pos = " + column);
        if ( spaceshipPos == column) {
            return;
        } else if (spaceshipPos < column) {
            for( int i = spaceshipPos; i < column; i++) {
                rightClicked();
            }
        } else {
            for( int i = spaceshipPos; i > column; i--) {
